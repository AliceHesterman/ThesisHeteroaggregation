...
class Particulates:
    ...
    def __init__(self, plastic_prop, MP_index):
        self.name = plastic_prop.name[MP_index]
        self.composition = plastic_prop.composition[MP_index]
        self.density_kg_m3 = plastic_prop.density_kg_m3[MP_index]
        self.shape = plastic_prop.MPshape[MP_index]
        self.diameter_um = plastic_prop.diameter_um[MP_index] #for spherical MPs and fibres. Should be 0 for all others.
        ...
        self.length_a_um = plastic_prop.length_a_um[MP_index] #longest length (for nonspherical MPs)
        self.length_a_m = self.length_a_um*10**-6 
        self.length_b_um = plastic_prop.length_b_um[MP_index] #intermediate length (for nonspherical MPs)
        self.length_b_m = self.length_b_um*10**-6 
        self.length_c_um = plastic_prop.length_c_um[MP_index] #shortest length (for nonspherical MPs)
    ...
    def calc_weight(self):
        self.wieght_kg = self.volume_m3*self.density_kg_m3
